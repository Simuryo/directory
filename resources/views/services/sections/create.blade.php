...
<div class="directory-content">
  ...
  <div class="card">
    <form action="{{ route('sections.store', $service->id) }}" method="post">
      {{ csrf_field() }}
      <div class="card-body">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control {{ $errors->first('head') ? ' is-invalid' : '' }}" value="{{ old('head') }}"  id="head" name="head" placeholder="Section Head">
        ...
        <div class="row">
          ...
          <div class="form-group col">
            ...
            <input type="text" class="form-control {{ $errors->first('ext') ? ' is-invalid' : '' }}" value="{{ old('ext') }}" id="ext" name="ext" placeholder="Local Number(s)">
            @if( $errors->first('ext') )
              <div class="invalid-feedback">
                {{ $errors->first('ext') }}
              </div>
